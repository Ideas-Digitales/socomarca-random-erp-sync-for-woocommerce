...
use Socomarca\RandomERP\Compat\LiteSpeedCacheVary;
use Socomarca\RandomERP\Compat\MultilocaSpanishLabels;
...
use Socomarca\RandomERP\Frontend\JetListingPriceTax;
